  ...
  return (
    <div className="main-grid min-h-screen">
      ...
      <main className="mx-auto w-full max-w-4xl px-4 py-14 md:px-6">
        <section className="rounded-3xl border border-ocean/25 bg-sand/80 p-8 shadow-soft">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-2">
            <a
              ...
              className="rounded-2xl border border-ocean/30 bg-cloud/60 p-4 transition hover:border-coral"
